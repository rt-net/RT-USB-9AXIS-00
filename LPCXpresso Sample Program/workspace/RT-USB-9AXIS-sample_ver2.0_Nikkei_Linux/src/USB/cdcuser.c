...
volatile unsigned char BulkBufIn  [USB_CDC_BUFSIZE];            // Buffer to store USB IN  packet
volatile unsigned char BulkBufOut [USB_CDC_BUFSIZE];            // Buffer to store USB OUT packet
volatile unsigned char NotificationBuf [10];

CDC_LINE_CODING CDC_LineCoding  = {4*223400, 0, 0, 8};
