...
static void modeSelectInfo(void)
{
    ...
    myPrintfUSB("  2 calib ACCXY       mode :flashing Green LED 0.5Hz  \n");
    myPrintfUSB("  3 calib ACCZ        mode :flashing Green LED 1Hz  \n");
    myPrintfUSB("  4 calib Mag         mode :flashing Green LED 2Hz  \n");
    myPrintfUSB("  5 viewAllData        mode :flashing Green LED 4Hz  \n");
    myPrintfUSB("  6 viewEEPROMData     mode :flashing Green LED 8Hz \n");
    myPrintfUSB("  7 clear offset       mode :flashing Green LED 16Hz \n");
    myPrintfUSB("  8 output mode select mode :flashing Green LED 32Hz \n");
}
        ...
        if( getSWcount() > 0 ) //SWでモード選択
        {
        	...
        	if(sw_count_max <3000)
        	{
				...
				switch(md_select){
					...
					break;
					case  2:  flashGreenLED(1000,1000);
					break;
					case  3:  flashGreenLED(500,500);
					break;
					case  4:  flashGreenLED(250,250);
					break;
					case  5:  flashGreenLED(125,125);
					break;
					case  6:  flashGreenLED(63,62);
					break;
					case  7:  flashGreenLED(32,31);
					break;
					case  8:  flashGreenLED(16,16);
					break;
				}
        	}
        	else //スイッチ長押し
